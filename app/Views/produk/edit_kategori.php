    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('kategori/update/' . $kategori['id_kategori']); ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?= (isset($errors['nama_kategori'])) ? 'is-invalid' : ''; ?>" id="nama_kategori" name="nama_kategori" value="<?= old('nama_kategori', $kategori['nama_kategori']); ?>">
